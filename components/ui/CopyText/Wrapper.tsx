      ...
      <span data-copied={isCopied} className={className}>
        ...
        <button onClick={copyText} className="absolute-with-grid">
          ...
          <CheckIcon
            ...
            className="ml-2 mr-1 size-3.5 rotate-[360deg] scale-0 opacity-0 duration-400 easing-[cubic-bezier(.98,-0.93,0,1.63)] data-visible:rotate-0 data-visible:scale-100 data-visible:opacity-100"
          />
          <CopyIcon
            data-visible={!isCopied}
            className="ml-2 mr-1 size-3.5 rotate-[360deg] scale-0 opacity-0 duration-400 easing-[cubic-bezier(.98,-0.93,0,1.63)] data-visible:rotate-0 data-visible:scale-100 data-visible:opacity-100"
